void pval_vs_lumi_qq()
{
   TCanvas c1("c1","");
   c1.SetLogy();

   TFile f25("testqq_short.root");
...
*/
   ...
   l5.SetLineStyle(3);
   l5.Draw();
   TLatex t5(140,2.87e-7,"5 #sigma");
   t5.SetTextSize(0.035);
   t5.Draw();



   c1.SaveAs("plot_qq.pdf");
}
